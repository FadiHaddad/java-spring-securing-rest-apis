...
public class UserRepositoryJwtAuthenticationConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    public AbstractAuthenticationToken convert(Jwt jwt) {
        ...
        OAuth2AuthenticatedPrincipal principal = new UserOath2AuthenticatedPrincipal(user,jwt.getClaims(),authorities);
        OAuth2AccessToken credentials = new OAuth2AccessToken(OAuth2AccessToken.TokenType.BEARER,
                jwt.getTokenValue(),null,null);
        return new BearerTokenAuthentication(principal,credentials,authorities);
    }

    private static class UserOath2AuthenticatedPrincipal extends User implements OAuth2AuthenticatedPrincipal {

        private final Map<String,Object> attributes;
        private final Collection<GrantedAuthority> authorities;

        public UserOath2AuthenticatedPrincipal(User user, Map<String,Object> attributes,
