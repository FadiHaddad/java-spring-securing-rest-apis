...
public class UserRepositoryOpaqueTokenIntrospector implements OpaqueTokenIntrospector {
    ...
    private final OpaqueTokenIntrospector delgate;
    private final UserRepository users;

    public UserRepositoryOpaqueTokenIntrospector(OpaqueTokenIntrospector delgate, UserRepository users){
    ...
    public OAuth2AuthenticatedPrincipal introspect(String token) {
        OAuth2AuthenticatedPrincipal principal = this.delgate.introspect(token);
    ...
    private static class UserOAuth2AuthenticatedPrincipal extends User implements OAuth2AuthenticatedPrincipal {
        ...
        public UserOAuth2AuthenticatedPrincipal(User user, Map<String,Object> attributes,
